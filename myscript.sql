...
CREATE TABLE KHU (
    ...
    CONSTRAINT FK_KHU FOREIGN KEY (Khu_MCN) REFERENCES CHINHANH (MaChiNhanh) ON DELETE CASCADE ON UPDATE CASCADE
);
-- @block 4 --
...
CREATE TABLE CHINHANH_CO_LOAIPHONG (
    ...
    CONSTRAINT FK_CO_LOAIPHONG FOREIGN KEY (Co_MLP) REFERENCES LOAIPHONG (MaLoaiPhong) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT FK_CO_CHINHANH FOREIGN KEY (Co_MCN) REFERENCES CHINHANH (MaChiNhanh) ON DELETE CASCADE ON UPDATE CASCADE
);
-- @block 7 --
CREATE TABLE PHONG (
    ...
    CONSTRAINT FK_PHONG_KHU FOREIGN KEY (Phong_MCN, Phong_TK) REFERENCES KHU (Khu_MCN, TenKhu) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT FK_PHONG_LOAIPHONG FOREIGN KEY (Phong_MLP) REFERENCES LOAIPHONG (MaLoaiPhong) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE LOAIVATTU_TRONG_LOAIPHONG (
    ...
    CONSTRAINT FK_TRONG_LOAIVATTU FOREIGN KEY (Trong_MLVT) REFERENCES LOAIVATTU (MaLoaiVatTu) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT FK_TRONG_LOAIPHONG FOREIGN KEY (Trong_MLP) REFERENCES LOAIPHONG (MaLoaiPhong) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE VATTU (
    ...
    VT_SP VARCHAR(3),
    CONSTRAINT FK_VATTU_LOAIVATTU FOREIGN KEY (VT_MLVT) REFERENCES LOAIVATTU (MaLoaiVatTu) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT FK_VATTU_PHONG FOREIGN KEY (VT_SP) REFERENCES PHONG (SoPhong) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT FK_PHONG_CHINHANH FOREIGN KEY (VT_MCN) REFERENCES PHONG (Phong_MCN) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE CUNGCAPVATTU (
    ...
    CCVT_MLVT VARCHAR(6),
    CCVT_MCN VARCHAR(50),
    CONSTRAINT FK_CCVT_NHACUNGCAP FOREIGN KEY (CCVT_MNCC) REFERENCES NHACUNGCAP (MaNhaCungCap) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT FK_CCVT_LOAIVATTU FOREIGN KEY (CCVT_MLVT) REFERENCES LOAIVATTU (MaLoaiVatTu) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT FK_CCVT_CHINHANH FOREIGN KEY (CCVT_MCN) REFERENCES CHINHANH (MaChiNhanh) ON DELETE CASCADE ON UPDATE CASCADE
);
-- @block 13 --
...
CREATE TABLE HINHANHCUAHANG(
    HACH_MCN VARCHAR(50) NOT NULL AUTO_INCREMENT,
    HACH_STTMatBang INT NOT NULL DEFAULT 1 CHECK (
        STTMatBang > 0
        AND STTMatBang < 51
    ),
    HinhAnh VARCHAR(255),
...
CREATE TABLE KHUNGGIOHOATDONG (
    KGHD_MCN VARCHAR(50) NOT NULL AUTO_INCREMENT,
    KGHD_STTMatBang INT NOT NULL DEFAULT 1 CHECK (
        STTMatBang > 0
        AND STTMatBang < 51
    ),
    GioBatDau TIME,
